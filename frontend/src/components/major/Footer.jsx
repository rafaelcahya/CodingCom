...
function Footer() {
    return (
        <div className="flex flex-col mt-20 lg:mt-56">
            <div className="footer-box flex flex-col items-center pb-10">
                <div className="bg-orange-1 my-10 py-10 px-10 md:px-20 lg:px-32 rounded-xl">
                    <div className="flex flex-col lg:flex-row items-center justify-center text-center lg:text-left gap-x-10 gap-y-10 lg:gap-y-0">
                        ...
                        <div className="flex flex-col md:flex-row items-center">
                            <input type="text" placeholder="Enter your email" className="subscribe font-size-base px-5 py-4 w-64 rounded-xl md:rounded-none md:rounded-tl-xl md:rounded-bl-xl outline-none"/>
                            <input type="submit" value="Subscribe" className="bg-blue-1 font-size-base text-white px-5 py-4 w-full md:w-auto rounded-xl md:rounded-none md:rounded-tr-xl md:rounded-br-xl outline-none" />
                        </div>
                    </div>
                </div>
