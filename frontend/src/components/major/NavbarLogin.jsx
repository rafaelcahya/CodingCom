                    ...
                    <div className="navbar-content text-sm relative lg:flex justify-between px-16 xl:px-32 border-b border-gray-200">
                        <div className=" flex items-center py-3">
                            ...
                            <div className="navbar flex items-center ml-12 gap-6 xl:gap-12" id="navbar">
                                ...
                                {login=="true" ? (
                                    ...
                                    activeClassName="navbar_active"
                                    className="navbar__link">
                                    <p className="navbar_btn underline_anim cursor-pointer">Challenges</p>
                                </NavLink>
                                ):(
                                    <div onClick={popup}
                                    activeClassName="navbar_active"
                                ...
                                {login=="true"?(
                                    ...
                                    activeClassName="navbar_active"
                                    className="navbar__link">
                                    <p className="navbar_btn underline_anim cursor-pointer">Coding Class</p>
                                </NavLink>
                                ):(
                                    <div onClick={popup}
                                    activeClassName="navbar_active"
                                ...
                                {login=="true" ? (
                                    ...
                                    activeClassName="navbar_active"
                                    className="navbar__link">
                                    <p className="navbar_btn underline_anim cursor-pointer">Career</p>
                                </NavLink>
                                ):(
                                    <div onClick={popup}
                                    activeClassName="navbar_active"
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <motion.div className="flex items-center gap-1 cursor-pointer"
                                ...
                                {login === "true"?( <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg>):("")}
                            </motion.div>
                        </div>
                    </div>
                </div>
                                ...
                                {loggedIn ? (
                                    <>
                                        <Link to="/login" className="text-sm text-red-500">
                                            <p onClick={logout} className="rounded-lg">Logout</p>
                                        </Link>
                                    </>
                                ) : (
                                    <>
