...
export default function NavbarMobile() {
    ...
    return (
        <>
            <nav className=""> 
                <div className="navbar fixed top-0 w-full flex lg:hidden justify-between items-center px-8 md:px-16 py-4 z-20 border-b-2 bg-white shadow-md">
                    <Link to="/">
                ...
                className="navbar-mobile fixed lg:hidden top-0 w-full flex flex-col px-16 py-5 bg-white z-10">
                    <Link to="/">
                        <p>Home</p>
                    </Link>
                    <Link to="/pricing">
