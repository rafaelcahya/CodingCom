...
import vueui from "../../../../asset/photo/challenge/certificate/vue.png"
        ...
        return (
            <>
                ...
                <div className="mx-8 sm:mx-24 md:mx-40 lg:mx-72 mt-32 lg:mt-20">
                    <p className="text-3xl font-semibold text-center my-10">VUE Certificate</p>
                    <div className="flex justify-center">
                        <img src={vueui} alt="" width="750" className="rounded-3xl"/>
                    </div>
                    <div className="flex flex-col gap-2 my-10">
                        <p className="font-semibold text-xl">Brief</p>
                        <p>Welcome to the VUE Challenge. In this challenge, you must create a Music Player App. Make it as close to the original as possible. You can use any tools you like to help you complete the challenge but you have to use VUE only. Download the project and go through the PDF file. This will provide further details about the project and help you get set up.</p>
                    </div> 
