        ...
        <>
            <div style={{padding: "0 10rem"}}>
                <div ref={ref} style={{width: 1200, height: 600}}>
                    {
                        value.map((val) => {
                            return <div className="certiticate flex flex-col items-center py-10">
                            ...
                            <p className="text-3xl text-center font-bold py-5 border-b border-gray-300 w-1/2">{val.projectTitle}</p>
                            <p className="text-2xl text-gray-500 font-medium my-5">{props.title}</p>
                            <p className="text-gray-500 text-center font-medium w-2/4 tracking-wide">This certification holder has passed the {val.projectTitle}. You are hereby deemed fully capable and skilled in Angular.</p>
