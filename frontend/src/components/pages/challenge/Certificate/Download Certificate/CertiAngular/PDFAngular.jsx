        ...
        <>
            <div ref={ref} style={{width: 1000, height: 600}}>
                <div className="flex flex-col items-center py-10">
                    ...
                    <p className="text-gray-500 text-center font-medium w-5/6 tracking-wide">This certification holder has passed the Angular Certification Project. You are hereby deemed fully capable and skilled in Angular.</p>
