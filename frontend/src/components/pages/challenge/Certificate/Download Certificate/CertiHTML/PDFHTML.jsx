...
const PDFHTML = (props) => {
    return (
        <>
            <div ref={ref} style={{width: 1000, height: 600}}>
                <div className="flex flex-col items-center py-10">
                    ...
                    <p className="text-3xl text-center font-bold py-5 border-b border-gray-300 w-1/2">HTML CSS Javascript Certified</p>
                    <p className="text-2xl text-gray-500 font-medium my-5">{props.title}</p>
                    <p className="text-gray-500 text-center font-medium w-5/6 tracking-wide">This certification holder has passed the HTML CSS Javascript Certification Project. You are hereby deemed fully capable and skilled in HTML, CSS and Javascript.</p>
            ...
            <Pdf targetRef={ref} options={options} x={150} y={110} scale={2} filename="certificate.pdf">
