            ...
            <div style={{padding: "0 10rem"}}>
                <div ref={ref} style={{width: 1200, height: 600}}>
                    <div className="certiticate flex flex-col items-center py-10">
                        ...
                        <p className="text-gray-500 text-center font-medium w-2/4 tracking-wide">This certification holder has passed the HTML CSS Javascript Certification Project. You are hereby deemed fully capable and skilled in HTML, CSS and Javascript.</p>
