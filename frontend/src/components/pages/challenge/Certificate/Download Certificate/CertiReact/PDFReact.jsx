        ...
        <>
            <div ref={ref} style={{width: 1000, height: 600}}>
                <div className="flex flex-col items-center py-10">
                    ...
                    <p className="text-3xl text-center font-bold py-5 border-b border-gray-300 w-1/2">React Certified</p>
                    <p className="text-2xl text-gray-500 font-medium my-5">{props.title}</p>
                    <p className="text-gray-500 text-center font-medium w-5/6 tracking-wide">This certification holder has passed the React Certification Project. You are hereby deemed fully capable and skilled in React.</p>
