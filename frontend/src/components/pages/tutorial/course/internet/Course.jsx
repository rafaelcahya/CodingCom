        ...
        <>
            ...
            <div className="mt-32 lg:mt-16 mx-10 md:mx-20 lg:mx-32 leading-7">
                <div className="w-full flex gap-10">
                    <div className="hidden lg:block sticky self-start top-0 pt-6 w-8/12">
                        ...
                        <div className="sidebar-tutorial flex flex-col gap-2 my-5">
                            ...
                            {
                                courseList.map((v)=>{
                                    return <div className="flex justify-between items-center hover:text-blue-500">
                ...
                <div className="z-50">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div className="flex flex-col gap-10">
                            <textarea placeholder="Add your rating here" cols={50} className="textarea resize-none cursor-text h-10" onChange={(event) => {
                                setDes(event.target.value)
                            }}></textarea>
                            <p onClick={Rate} id="submitRating" className="bg-blue-1 text-center text-white px-4 py-1 rounded-lg cursor-pointer">Rate Now</p>
                        </div>
