...
export class RoadmapComp extends Component {
    render() {
        return (
            <>
            {/* mt-44 lg:mt-24 mx-10 lg:mx-20 */}
                <div className="flex flex-col items-center">
                    <div className="roadmap-header w-full py-48 text-white">
                        <div className="flex flex-col items-center text-center gap-2">
                            <h1 className="text-4xl font-semibold">{this.props.header}</h1>
                    ...
                    <div className="roadmap mt-10">
                        <img src={this.props.image} alt="" width="900"/>
                    </div>
                </div>
            </>
        )
