...
export default function RoadmapFrontend() {
    return (
        <>
            <NavbarLogin/>
            <NavbarMobile/>
            <div className="bg-blue-1 text-white w-full py-32">
                <div className="flex flex-col items-center text-center gap-2">
                    <h1 className="text-4xl font-semibold">Frontend Developer Roadmap</h1>
                    <p className="text-sm">Supported by</p>
                    <div className="flex flex-col sm:flex-row items-center gap-5 mt-10 sm:mt-0">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <a href="https://youtube.com/channel/UCA0H2KIWgWTwpTFjSxp0now" className="text-sm hover:underline">the roadmap</a>
                        </div>
                    </div>
                </div>
            </div>
            <div className="mx-8 sm:mx-24 mt-32 lg:mt-20 flex justify-center">
                <img src={frontend} alt="Roadmap Frontend" width={800}/>
            </div>
