...
export default function PremiumPlanPlus() {
    const modal = useRef()
    return (
        <>
            <NavbarLogin/>
            ...
            <section className="payment-container bg-blue-2 mt-32 lg:mt-20 mb-40 mx-5 xs:mx-10 sm:mx-24 md:mx-32 lg:mx-52 xl:mx-96 py-10 rounded-3xl">
                <div className="flex flex-col justify-center items-center">
                    <p className="text-2xl font-semibold mb-10">Premium Plan Plus</p>
            ...
            <>
                <div className="flex justify-between items-center gap-10 my-5">
                    ...
                    <div className="flex gap-5">
                        ...
                        <a href="mailto:codingpaymentcom@gmail.com?subject=Payment Confirmation&body=hello coding.com, I've done the payment transfer process for Rp. 430,000." className="bg-green-1 text-white text-sm rounded-lg py-2 px-4">Sure</a>
                    </div>
                </div>
            </>
        )
