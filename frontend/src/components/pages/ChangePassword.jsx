        ...
        <>
            <div className="login-container flex justify-center py-10 h-screen">
                ...
                <div className="login-box rounded-lg p-10 shadow-xl overflow-hidden">
                    <p className="color-blue-1 text-xl font-semibold mb-2">change Password</p>
                    <p className="text-sm">Enter your old password and new password here</p>
                    <div className="flex flex-col my-10">
                        <div className="flex flex-col gap-5">
                        <div>
                                <div className="flex justify-between">
                                    <p className="password text-sm font-semibold mb-2 color-black-2">Old Password</p>
                                </div>
                                <input
                                    type="text"
                            ...
                            <div>
                                <div className="flex justify-between">
                                    <p className="password text-sm font-semibold mb-2 color-black-2">New Password</p>
                                </div>
                                <input
                                    type="text"
                            ...
                            <div>
                                <div className="flex justify-between">
                                    <p className="password text-sm font-semibold mb-2 color-black-2">Confirm New Password</p>
                                </div>
                                <input
                                    type="text"
