                                                        ...
                                                        <div className="flex items-center gap-5">
                                                            <p onClick={() => toggleShow(!show)} className="cursor-pointer">Cancel</p>
                                                            {
                                                                val.classUrl.match(/[https://]/) != null ? (
                                                                    ...
                                                                    <a href={"https://"+val.classUrl} target="_blank" rel="noreferrer" onClick={reset} className="bg-blue-1 text-white text-center font-semibold px-6 py-2 rounded-md cursor-pointer">Join</a>
                                                                )
                                                            }
                                                        </div>
                                                        <div className="flex items-center gap-1">
