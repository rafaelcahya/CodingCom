...
export default function ListReceipt() {
    ...
    useEffect(() => {
        axios.get("http://localhost:3001/receipt/receiptListMentor/"+ localStorage.getItem("name")).then((response) => {
        ...
        <>
            <div className="flex h-screen overflow-hidden text-black bg-white">
                ...
                <div className="table-request-class overflow-hidden ml-72 m-5 p-8 flex flex-col gap-1 bg-white border border-gray-300 rounded-lg w-full" >
                    ...
                    <p className="text-sm font-semibold">List of receipt that have been sended by admin.</p>
                                                ...
                                                (val) => {
                                                    return <tr className="border-b-2">
                                                        ...
                                                        <td className="px-6 py-3 whitespace-nowrap">
                                                            <Link to={"/mentor/receipt-detail-"+val.receiptId}>
                                                            Detail
                                                            </Link>
                                                        </td> 
                                                    </tr>
